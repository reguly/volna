...
//  op_partition("PTSCOTCH", "KWAY", cells, edgesToCells, NULL);
//  op_partition("PTSCOTCH", "GEOM", NULL, edgesToCells, NULL);
...
//  op_get_permutation(&edges_perm, &edges_iperm, edgesToEdges, edges);
