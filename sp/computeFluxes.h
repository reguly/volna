                                ...
                                float *maxEdgeEigenvalues) //OP_WRITE
{
  ...
  if (!*isRightBoundary) {
     ...
     */ //end HEIGHTSUBC
     ...
     /*if(leftCellValues[3] < -10.0f){
     rightCellValues[0] = -1.0f*rightCellValues[3];
     outNormalVelocity = inNormalVelocity;
     outNormalVelocity -=
     2.0 * sqrt( g * cellLeft[0] );
     outNormalVelocity +=
     ...
     if((leftcellCenters[0] > -230000) &&(leftcellCenters[0] < -210000) && (leftcellCenters[1] < -265000)){
       rightCellValues[0] = cellLeft[0];
       outNormalVelocity =  -1.0f*inNormalVelocity;
       outTangentVelocity = inTangentVelocity;
     }
     if((leftcellCenters[1] > 170000) &&(leftcellCenters[1] < 185000) && (leftcellCenters[0] < -550000)){
       rightCellValues[0] = cellLeft[0];
       outNormalVelocity =  -1.0f*inNormalVelocity;
       outTangentVelocity = inTangentVelocity;
     }
     if((leftcellCenters[0] > 165000) &&(leftcellCenters[0] < 185000) && (leftcellCenters[1] < -265000)){
       rightCellValues[0] = cellLeft[0];
       outNormalVelocity =  -1.0f*inNormalVelocity;
       outTangentVelocity = inTangentVelocity;
     }*/
