...
#define STRIDE(x,y) x
extern int nodes_stride;
extern int edges_stride;
extern int cells_stride;
extern int outputLocation_stride;
extern int bathy_nodes_stride;
//
...
void op_par_loop_initBathymetry_large(char const *, op_set,
  op_arg,
  op_arg,
  op_arg,
  op_arg,
...
void op_par_loop_initBathyRelative_formula(char const *, op_set,
  op_arg,
  op_arg,
  op_arg,
  op_arg );
  ...
  if (fromFile) {
    ...
    if (new_format) {
      ...
      op_par_loop_applyConst("applyConst",cells,
                  ...
                  op_arg_dat(values,-1,OP_ID,4,"float",OP_RW),
                  op_arg_gbl(&variable,1,"int",OP_READ));
      op_par_loop_initBathymetry_large("initBathymetry_large",cells,
                  op_arg_dat(values,-1,OP_ID,4,"float",OP_RW),
                  op_arg_dat(cellCenters,-1,OP_ID,2,"float",OP_READ),
